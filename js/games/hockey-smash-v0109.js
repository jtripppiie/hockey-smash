(function () {
  ...
  function onReady() {
    ...
    document.body.dataset.hockeyButtonDebug = 'v0.13.1';

    normalizeSofieLabels();
    window.HOCKEY_BOOT_LOG?.log?.('v0109', 'Dance Smash mode labels, pointe shoe action button, and accidental camera shake lock active.');
