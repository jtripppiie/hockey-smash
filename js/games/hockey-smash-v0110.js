(function () {
  /*
   * Hockey Smash v0.13.6 final release marker.
   *
  ...
  function onReady() {
    ...
    document.body.dataset.hockeyButtonDebug = 'v0.13.6';
    window.HOCKEY_BOOT_LOG?.log?.('v0110', 'v0.13.6 charged shots, salmon variants, combo spawns, and safe powerups loaded.');
  }
