(function () {
  ...
  const PERSON_TYPES = new Set(['teacher', 'danceInstructor', 'sister', 'adultCoach']);
  const TUNING = {
    introSeconds: 20,
    fullRampSeconds: 115,
    bigStart: 0.58,
  ...
  function signFor(entity, fallback = -1) {
    if (entity.type === 'danceInstructor' || entity.type === 'teacher' || entity.type === 'adultCoach' || entity.type === 'sister') {
