...
test('root serves Hockey Smash game', async ({ page }) => {
  ...
  expect(requestedUrls.some((url) => url.includes('hockey-smash-world-v2.js?v=1.5.1'))).toBe(true);
  expect(requestedUrls.some((url) => url.includes('hockey-smash-renderer-v2.js?v=1.5.1'))).toBe(true);
  expect(requestedUrls.some((url) => url.includes('hockey-smash-systems-v2.js?v=1.5.1'))).toBe(true);
