...
const requiredFiles = [
  ...
  'assets/hockey-smash/sprites/moose-static-v2.png',
...
if (packageJson.version !== '2.4.0') errors.push('package.json version should be 2.4.0.');
...
requireText('v2 harness', harness, "const VERSION_FALLBACK = '2.4.0'", 'V2 version fallback should match package.json.');
...
requireText('v2 systems', systemsSource, "golden: 'GOLDEN', swift: 'SWIFT', heavy: 'HEAVY'", 'V2 salmon variant feedback labels are missing.');
...
requireText('v2 harness', harness, 'hockey-smash-world-v2.js?v=2.4.0', 'V2 world script include should be cache-busted.');
requireText('v2 harness', harness, 'hockey-smash-renderer-v2.js?v=2.4.0', 'V2 renderer script include should be cache-busted.');
requireText('v2 harness', harness, 'hockey-smash-systems-v2.js?v=2.4.0', 'V2 gameplay systems script include should be cache-busted.');
requireText('v2 systems', systemsSource, 'function applySalmonVariant', 'V2 salmon variant tuning is missing.');
requireText('v2 systems', systemsSource, "variant === 'heavy'", 'V2 heavy salmon behavior is missing.');
...
requireText('v2 world', worldSource, 'moose-static-v2.png', 'V2 clean static moose asset is missing.');
...
forbidText('v2 renderer', rendererSource, 'getLegacySheetFallback', 'Retired creature fallback selection should stay removed.');
forbidText('v2 renderer', rendererSource, 'mooseWalkSheet', 'Static moose should not use sprite-sheet animation.');
...
if (!World) {
  ...
  if (salmon.width !== 66 || salmon.height !== 33) errors.push('V2 salmon dimensions changed unexpectedly.');
}
