...
if (packageJson.version !== '2.0.0') errors.push('package.json version should be 2.0.0.');
...
requireText('v2 harness', harness, "const VERSION_FALLBACK = '2.0.0'", 'V2 version fallback should match package.json.');
...
requireText('v2 harness', harness, 'hockey-smash-world-v2.js?v=2.0.0', 'V2 world script include should be cache-busted.');
requireText('v2 harness', harness, 'hockey-smash-renderer-v2.js?v=2.0.0', 'V2 renderer script include should be cache-busted.');
requireText('v2 harness', harness, 'hockey-smash-systems-v2.js?v=2.0.0', 'V2 gameplay systems script include should be cache-busted.');
