...
- Alaska kid cameo appears briefly, says `Hi, you're cute`, and leaves after about 4-5 seconds in the current v2 tuning
...
- Alaska kid cameo lifetime is about 4-5 seconds in the current v2 tuning
